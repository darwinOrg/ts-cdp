...
export class BrowserWebSocketServer {
  ...
  private async handleMessage(
    ...
    switch (message.type) {
      ...
      case "element_all_attributes":
        await this.elementAllAttributes(
          sessionId,
          message.pageId,
          message.data,
        );
    ...
    try {
      ...
      this.sendError(
        ...
        error instanceof Error
          ? error.message
          : "Failed to check element exists",
      );
    }
  }

  private async elementText(
    sessionId: string,
    pageId?: string,
    data?: any,
  ): Promise<void> {
  ...
  private async elementSetValue(
    ...
    try {
      ...
      this.sendError(
        session.ws,
        data?.requestId,
        error instanceof Error ? error.message : "Failed to set element value",
      );
    }
  }

  private async elementWait(
    sessionId: string,
    pageId?: string,
    data?: any,
  ): Promise<void> {
  ...
  private async elementAttribute(
    sessionId: string,
    pageId?: string,
    data?: any,
  ): Promise<void> {
  ...
  private async elementAllTexts(
    ...
    try {
      ...
      this.sendError(
        ...
        error instanceof Error
          ? error.message
          : "Failed to get all element texts",
      );
    }
  }

  private async elementAllAttributes(
    sessionId: string,
    pageId?: string,
    data?: any,
  ): Promise<void> {
    ...
    try {
      ...
      this.sendError(
        ...
        error instanceof Error
          ? error.message
          : "Failed to get all element attributes",
      );
    }
  }

  private async elementCount(
    sessionId: string,
    pageId?: string,
    data?: any,
  ): Promise<void> {
    ...
    try {
      ...
      this.sendError(
        session.ws,
        data?.requestId,
        error instanceof Error ? error.message : "Failed to get element count",
      );
    }
  }
  ...
  private sendResponse(
    ...
    if (ws && ws.readyState === WebSocket.OPEN) {
      logger.info(
        `Sending WebSocket response: type=${response.type}, requestId=${response.requestId}`,
      );
      ws.send(JSON.stringify(response));
      logger.info(`WebSocket response sent: type=${response.type}`);
    } else {
      logger.warn(
        `WebSocket not ready: ws=${!!ws}, readyState=${ws?.readyState}, type=${response.type}`,
      );
    }
  }
  ...
  private async navigateWithLoadedState(
    sessionId: string,
    message: any,
  ): Promise<void> {
    const session = this.sessions.get(sessionId);
    ...
    try {
      ...
      this.sendError(
        ...
        error instanceof Error
          ? error.message
          : "Failed to navigate with loaded state",
      );
    }
  }

  private async reloadWithLoadedState(
    sessionId: string,
    message: any,
  ): Promise<void> {
    const session = this.sessions.get(sessionId);
    ...
    try {
      ...
      this.sendError(
        ...
        error instanceof Error
          ? error.message
          : "Failed to reload with loaded state",
      );
    }
  }

  private async waitForLoadStateLoad(
    sessionId: string,
    message: any,
  ): Promise<void> {
    const session = this.sessions.get(sessionId);
  ...
  private async waitForDomContentLoaded(
    ...
    try {
      ...
      this.sendError(
        ...
        error instanceof Error
          ? error.message
          : "Failed to wait for DOM content loaded",
      );
    }
  }

  private async waitForSelectorStateVisible(
    sessionId: string,
    message: any,
  ): Promise<void> {
    const session = this.sessions.get(sessionId);
  ...
  private async expectResponseText(
    sessionId: string,
    message: any,
  ): Promise<void> {
    const session = this.sessions.get(sessionId);
    ...
    try {
      ...
      this.sendError(
        ...
        error instanceof Error
          ? error.message
          : "Failed to expect response text",
      );
    }
  }
  ...
  private async mustInnerText(sessionId: string, message: any): Promise<void> {
    ...
    try {
      ...
      this.sendError(
        session.ws,
        message?.requestId,
        error instanceof Error ? error.message : "Failed to get inner text",
      );
    }
  }

  private async mustTextContent(
    sessionId: string,
    message: any,
  ): Promise<void> {
    const session = this.sessions.get(sessionId);
    ...
    try {
      ...
      this.sendError(
        session.ws,
        message?.requestId,
        error instanceof Error ? error.message : "Failed to get text content",
      );
    }
  }
  ...
  private async close(sessionId: string, message: any): Promise<void> {
    ...
    try {
      ...
      this.sendError(
        session.ws,
        message?.requestId,
        error instanceof Error ? error.message : "Failed to close all",
      );
    }
  }
  ...
  private async expectExtPage(sessionId: string, message: any): Promise<void> {
    ...
    try {
      ...
      this.sendError(
        session.ws,
        message?.requestId,
        error instanceof Error ? error.message : "Failed to expect ext page",
      );
    }
  }
}
